...
from .models import TFC, AptidoesCompetencias, Area, Autor, Blog, BlogOwner, Cadeira, Comentario, Contacto, Curso, CursoModelo, Formacao, Interesses, LaboratoriosPW, LinkRepos, Pessoa, Post, Rodape, Tarefa, TecnologiasPW, TipoCompetencias, noticiasPW, sobreEsteWS
